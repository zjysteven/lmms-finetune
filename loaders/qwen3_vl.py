...
from transformers import AutoProcessor, Qwen3VLForConditionalGeneration, PreTrainedTokenizer, AutoConfig
...
class Qwen3VLModelLoader(BaseModelLoader):
    def load(self, load_model: bool = True) -> Tuple[Qwen3VLForConditionalGeneration, PreTrainedTokenizer, AutoProcessor, AutoConfig]:
        if load_model:
